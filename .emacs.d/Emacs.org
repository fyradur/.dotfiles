...
(defun apollo/new-unsorted-file ()
  "Create a new file with the default name being the date of today in the directory /home/john/playground/unsorted."
  (interactive)
  (let ((filename (concat "playground/unsorted/" (format-time-string "%Y-%m-%d"))))
    (find-file (read-file-name "File name: " nil nil nil filename))))
