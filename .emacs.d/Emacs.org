   ...
   #+begin_src emacs-lisp
      ...
      (apollo/leader-keys
       ...
       ;; Avy stuff
          ...
          "ps" '(apollo/pomo-points/subtract-cent :which-key "Subtract 100 points")
...
(cond
 ...
 ((>= minutes 20) (format "%d minutes - Earned: 75p | 25min = 100p" minutes))
 ((>= minutes 15) (format "%d minutes - Earned: 60p | 20min = 75p" minutes))
 ((>= minutes 10) (format "%d minutes - Earned: 40p | 15min = 60p" minutes))
 ((>= minutes 5) (format "%d minutes - Earned: 20p | 10min = 40p" minutes))
 ((>= minutes 2) (format "%d minutes - Earned: 10p | 5min = 20p" minutes))
 ((>= minutes 1) (format "%d minutes - Earned: 2p | 2min = 10p" minutes))
 ((>= minutes 0) (format "%d minutes - Earned: 0p | 1min = 2p" minutes)))))
#+end_src
...
* Org-ref
#+begin_src emacs-lisp
(setq reftex-default-bibliography '("/home/john/texstuff/ref.bib"))
(setq org-ref-default-bibliography '("/home/john/texstuff/ref.bib"))
#+end_src
...
(defun apollo/create-tex-project ()
  (interactive)
  (let ((project (ivy-read "Name of project: " '())))
    (shell-command
    ...
    (find-file (format "/home/john/Documents/skola/randomtex/%s/file.org" project)))
  (delete-other-windows)
  (evil-window-vsplit)
  (evil-window-right 1)
  (evil-window-decrease-width 10))
